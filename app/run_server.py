...
modelpath = "C:/Users/ksuro/PycharmProjects/pythonProject3/venv/Models/gb_pipeline.dill"
...
def predict():
	...
	if flask.request.method == "POST":
		...
		logger.info(f'{dt} Data: age={age}, height={height}, weight={weight}, ap_hi={ap_hi}, ap_lo={ap_lo}, gender={gender}, '
					f'cholesterol={cholesterol}, gluc={gluc}, smoke={smoke}, alco={alco}, active={active}')
		try:
